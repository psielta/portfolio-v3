  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mt-8 p-6 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
        <h2 className="text-2xl font-semibold mb-4 text-white">Sobre os Elementos Orbitais</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <h3 className="font-semibold mb-2 text-blue-400">Distância do Periélio (qr)</h3>
            <p className="text-white/70">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-blue-400">Excentricidade (ecc)</h3>
            <p className="text-white/70">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-blue-400">Inclinação (inc)</h3>
            <p className="text-white/70">
              A inclinação do plano orbital em relação ao plano da eclíptica, medida em graus.
            </p>
          </div>
          <div>
            <h3 className="font-semibold mb-2 text-blue-400">RAAN</h3>
            <p className="text-white/70">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-blue-400">Argumento do Periélio (ω)</h3>
            <p className="text-white/70">
          ...
          <div>
            <h3 className="font-semibold mb-2 text-blue-400">Tempo do Periélio (tp)</h3>
            <p className="text-white/70">
